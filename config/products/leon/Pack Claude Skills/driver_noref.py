...
out = prod/"output"/"criativos"; out.mkdir(parents=True, exist_ok=True)
prompts = json.loads((prod/"output"/"prompts.json").read_text(encoding="utf-8"))
